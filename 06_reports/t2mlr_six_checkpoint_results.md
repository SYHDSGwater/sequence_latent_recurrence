...
|---|---:|---:|---:|
| 135m_10b_wiki | +0.01950 [+0.01749, +0.02156] | +1.63660 | +0.00147 [+0.00056, +0.00254] |
| 135m_10b_math | +0.03165 [+0.02632, +0.03709] | +1.84674 | -0.00085 [-0.00167, +0.00001] |
| 135m_50b_wiki | +0.00748 [+0.00606, +0.00892] | +2.75868 | +0.00125 [+0.00033, +0.00232] |
| 135m_50b_math | +0.03445 [+0.02813, +0.04053] | +4.77912 | +0.00023 [-0.00121, +0.00164] |
| 362m_10b_wiki | +0.01135 [+0.01005, +0.01270] | +2.86054 | +0.00058 [+0.00002, +0.00114] |
| 362m_10b_math | +0.01560 [+0.01254, +0.01871] | +3.87745 | +0.00001 [-0.00092, +0.00091] |
| 362m_50b_wiki | +0.02806 [+0.02621, +0.02981] | +7.03190 | +0.00604 [+0.00363, +0.00869] |
| 362m_50b_math | +0.02089 [+0.01716, +0.02462] | +7.20634 | +0.01014 [+0.00571, +0.01459] |
| 982m_10b_wiki | +0.01067 [+0.00943, +0.01190] | +1.94993 | +0.00081 [+0.00021, +0.00145] |
| 982m_10b_math | +0.01300 [+0.00986, +0.01622] | +1.40362 | -0.00077 [-0.00154, +0.00000] |
| 982m_50b_wiki | +0.02041 [+0.01883, +0.02193] | +5.09889 | +0.00090 [+0.00012, +0.00172] |
| 982m_50b_math | +0.02451 [+0.02066, +0.02862] | +4.74335 | -0.00102 [-0.00210, +0.00006] |

## 同规模 50B 减 10B 的配对效应差
...
|---|---:|---:|
| 135m_wiki | -0.01202 [-0.01417, -0.00998] | -0.00022 [-0.00130, +0.00086] |
| 135m_math | +0.00280 [-0.00272, +0.00815] | +0.00107 [-0.00041, +0.00263] |
| 362m_wiki | +0.01670 [+0.01475, +0.01854] | +0.00546 [+0.00301, +0.00816] |
| 362m_math | +0.00530 [+0.00084, +0.00975] | +0.01013 [+0.00593, +0.01438] |
| 982m_wiki | +0.00974 [+0.00799, +0.01155] | +0.00009 [-0.00080, +0.00096] |
| 982m_math | +0.01152 [+0.00692, +0.01614] | -0.00025 [-0.00147, +0.00094] |

## 基线预测与非负远期差异

| checkpoint / 数据 | 正常平均 NLL | 自然 reset 远期绝对 ΔNLL | clean-KV 远期绝对 ΔNLL | clean-KV 远期 signed ΔNLL，95% CI |
|---|---:|---:|---:|---:|
| 135m_10b_math | 3.55320 | 0.03059 | 0.01768 | -0.00032 [-0.00078, +0.00017] |
| 135m_10b_wiki | 3.44534 | 0.02723 | 0.01625 | +0.00013 [-0.00019, +0.00048] |
| 135m_50b_math | 3.19189 | 0.04141 | 0.02396 | -0.00045 [-0.00105, +0.00018] |
| 135m_50b_wiki | 3.00165 | 0.02958 | 0.02054 | -0.00018 [-0.00051, +0.00015] |
| 362m_10b_math | 3.08890 | 0.03241 | 0.01486 | -0.00014 [-0.00053, +0.00024] |
| 362m_10b_wiki | 2.94089 | 0.02450 | 0.01408 | -0.00002 [-0.00031, +0.00031] |
| 362m_50b_math | 2.74587 | 0.09184 | 0.02314 | -0.00066 [-0.00122, -0.00013] |
| 362m_50b_wiki | 2.65813 | 0.04789 | 0.02061 | +0.00034 [-0.00004, +0.00072] |
| 982m_10b_math | 2.86992 | 0.02727 | 0.01478 | -0.00014 [-0.00056, +0.00029] |
| 982m_10b_wiki | 2.75416 | 0.02396 | 0.01388 | -0.00019 [-0.00048, +0.00009] |
| 982m_50b_math | 2.59020 | 0.03904 | 0.02032 | +0.00015 [-0.00039, +0.00067] |
| 982m_50b_wiki | 2.44308 | 0.02999 | 0.01803 | -0.00018 [-0.00051, +0.00014] |

## 判断与限定

预定义远期 ±0.01 nat/token 判据：23/24 个 checkpoint×数据×KV条件的 95% CI 完整位于区间内。未达到的条件：362m_50b_math/reset_once。
...
新增八个正式 cell 累计 1731.7 秒（28.9 分钟），不包括下载、预取和人工准备；不是总计费时长。没有执行 Jacobi 假说训练。
